...
router
  ...
  .put('/like/:id', protect, controller.likeThread, controller.getThreadsByAllUsers)
  .put('/unlike/:id', protect, controller.unlikeThread, controller.getThreadsByAllUsers)
